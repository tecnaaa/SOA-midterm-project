      ...
      <div className="step-content">
        ...
        <div className="input-row">
          <div className="input-group half-width">
            ...
            <input type="text" value={defaultData.fullName} readOnly className="read-only" />
          </div>
          ...
          <div className="input-group half-width">
            ...
            <input 
              type="text" 
              value={`${defaultData.availableBalance.toLocaleString()} VND`} 
              readOnly 
        ...
        <div className="input-row">
          <div className="input-group full-width">
            ...
            <input type="text" value={defaultData.email} readOnly className="read-only" />
          </div>
        </div>
